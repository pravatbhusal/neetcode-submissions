...
2. Coins for that final pop = nums[l-1] * nums[i] * nums[r+1]
3. Divide into two independent subproblems:
    a. helper(l, i-1): best way to burst everything to the left of i first
    b. helper(i+1, r): best way to burst everything to the right of i first
    ...
    def maxCoins(self, nums: List[int]) -> int:
        ...
        def helper(l, r):
            ...
            for i in range(l, r + 1):
                ...
                # recurse left-side without i
                coins += helper(l, i - 1)
                # recurse right-side without i
                coins += helper(i + 1, r)
