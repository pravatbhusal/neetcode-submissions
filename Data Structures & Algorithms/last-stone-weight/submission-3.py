class Solution:
    ...
    keep smashing the stones until there is only 0 or 1 stones remaining
    """

    """
    Solution: a max heap where heappop to get largest stone
    and heappop again to get the 2nd largest stone
    ...
    def lastStoneWeight(self, stones: List[int]) -> int:
        ...
        # negative sign all numbers to simulate max heap
