...
class Solution:
    def isValidBST(self, root: Optional[TreeNode]) -> bool:
        # A child node's value is always in a range between the parent and grandparent
        # We need to track the subtree min/max and keep track of the grandparent too
