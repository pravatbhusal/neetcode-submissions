...
Question: After backtrack, why don't we call helper(row + 1) again? This is because there is never a valid
case where we don't put Q on a row, so we don't want to recurse that invalid path.
"""
class Solution:
