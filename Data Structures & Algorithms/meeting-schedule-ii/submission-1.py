...
This problem is to count the number of non-overlapping intervals. Non-overlapping
intervals can have their own room. Overlapping intervals must be put in a
separate room.
