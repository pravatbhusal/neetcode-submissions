...
3. When the start time of a new meeting is less than the largest end time
seen so far, then add a new room. Because the end_times array is sorted, as
we move the end_ptr we'll encounter the new largest room seen so far.
"""
class Solution:
