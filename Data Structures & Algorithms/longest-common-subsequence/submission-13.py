...
class Solution:
    def longestCommonSubsequence(self, text1: str, text2: str) -> int:
        ...
        # Note: m + 1 and n + 1 to prevent python wrap around from dp[-1][-1]
