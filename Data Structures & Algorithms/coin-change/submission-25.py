"""
Unbounded Knapsack Problem (can use coins[i] multiple times)
...
Since greedy fails, we can use DP to solve this. Find the most optimal way to coin change create a DP array of
size amount, and build up the solution till amount.
