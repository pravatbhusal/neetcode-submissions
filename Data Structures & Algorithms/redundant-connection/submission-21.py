...
class Solution:
    ...
    def findRedundantConnection(self, edges: List[List[int]]) -> List[int]:
        ...
        def union(n1, n2):
            ...
            if r1 == r2:
                # n1 and n2 are already connected
                # unioning n1 and n2 again creates a redundant connection (cycle)
                return False
    ...
    """
    Note: Keeping this Topological Sort solution because it is a valid.
    ...
    What we're trying to detect here is where the "cycle" begins.
