...
The algorithm is greedy because at every step it makes the locally optimal choice of
always starting a new group from the smallest available card, without reconsidering
that decision later.
"""
class Solution:
    def isNStraightHand(self, hand: List[int], groupSize: int) -> bool:
        ...
        freqs = Counter(hand)
        # heapify the unique hands from the dict
