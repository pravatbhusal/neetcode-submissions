...
class Solution:
    def getSum(self, a: int, b: int) -> int:
        ...
        max_pos = 0x7FFFFFFF # 01111111... = 32 bits, positive twos complement
        max_neg = 0xFFFFFFFF # 11111111... = 32 bits, negative twos complement
        if result > max_pos:
            # result is negative twos complement
