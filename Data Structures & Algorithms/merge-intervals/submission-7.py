...
There are two cases:
1. No overlap: curInterval starts after lastInterval ends, append curInterval to result
2. Overlap: curInterval and lastInterval overlap, merge by updating lastInterval's end to the larger of the two
"""
class Solution:
