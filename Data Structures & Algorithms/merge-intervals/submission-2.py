...
There are three cases to merge intervals:
1. After curInterval, where curInterval is immediately before newInterval 
2. Merge (override), where two intervals overlap with newInterval
"""
class Solution:
