...
Dynamic Programming (Bottom-up) 2D space solution:
...
Before iterating in reverse, we seed dp[i][m] = 1 because when j == len(t),
we've fully matched t — count it as 1 valid subsequence.

Dynamic Programming (Bottom-up) 1D space solution:
